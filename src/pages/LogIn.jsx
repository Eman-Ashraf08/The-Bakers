    ...
    <section className="text-gray-600 body-font px-4 py-8 sm:px-6 md:px-8 lg:px-16 xl:px-40">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-center">
        <div className="md:w-1/2 lg:w-3/5 mb-8 md:mb-0">
          <h1 className="title-font font-medium text-3xl text-pink-500 mb-4">HTML CSS Login Form</h1>
        ...
        <div className="md:w-1/2 lg:w-2/6 bg-pink-500 rounded-lg p-8 flex flex-col mx-auto w-full max-w-md">
